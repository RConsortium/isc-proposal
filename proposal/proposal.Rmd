...
set up local versions of these systems to test their functionality and ease of 
...
These four systems will be evaluated by installing locally, testing the claimed
features of each system and identifying the pros and cons of each. Based on 
this evaluation a system will be selected and set up in preparation for 
